...
export const FIELDS=['summary','value','context','usage','verdictA','verdictB','accept','overall'];
...
export function parseGeminiResponse(body,evidence=null){
 ...
 return {...report,roster:'',schedule:'',researchMode:'source-context',searchSuggestions:'',sources:[]};
}
